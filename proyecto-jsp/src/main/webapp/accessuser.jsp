    ...
    <div class="container-fluid">
        <div class="row">
            <nav class="col-lg-2 navbar navbar-expand-lg navbar-light bg-light flex-column" style="width: 160px;">
                ...
                <p class="text-white"><i class="bi bi-person-fill"></i> <strong class="red-text">Usuario:<%= usuario %></strong></p>
                <a class="btn add-jornada-btn mt-3 mb-3" href="comments2.jsp">Agregar Comentario</a>
